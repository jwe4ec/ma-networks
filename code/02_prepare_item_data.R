...
# For now, assume all of these are in EST time zone (note: EST, or UTC - 5, all year, 
# not "America/New York", which switches between EST and EDT). However, note that
# "task_log" columns seem to be an hour different from other tables' timestamps).
